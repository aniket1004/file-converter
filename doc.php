...
if($_FILES){
	...
	$upload = $obj->upload_document($_FILES, 'uploads', 'fileToUpload');
	if($upload){
		$imageName = urlencode($upload[0]);
		$imageType = urlencode($upload[1]);
		
		header('Location: convertdocument.php?imageName='.$imageName.'&imageType='.$imageType);
	}
}	
?>
...
<html>
	...
	<body class="is-preload">
		...
		<tr><td align="center" style="background-color:thistle;">	<h2 align="center">Document Converter</h2></td></tr>
		<tr><td align="center"><h4>Convert ant document to PDF,DOC,PPT</h4></td></th>
		<tr>
			<td align="center">
